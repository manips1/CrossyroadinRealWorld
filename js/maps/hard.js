...
export function initHardMap(scene, world, controls, camera) {
    // 맵 배경 택스쳐 이미지 
    const texture = Utils.cubeLoader.load([
        'image/background/view/hardview1.png',
        'image/background/view/hardview3.png',
        'image/background/view/hardview1.png',
        'image/background/view/hardview1.png',
        'image/background/view/hardview4.png',
        'image/background/view/hardview2.png',

...
export const Level="Normal";

export function initNormalMap(scene, world, controls, camera) {
    // 맵 배경 택스쳐 이미지 
    const texture = Utils.cubeLoader.load([
        'image/background/view/2normalview1.png',
        'image/background/view/2normalview3.png',
        'image/background/sky/2normalsky.png',
        'image/background/ground/2normalground.png',
        'image/background/view/2normalview4.png',
        'image/background/view/2normalview2.png',
    ]);
    ...
    Utils.textureLoader.load('image/background/ground/road2.jpg', (texture) => {
        ...
        // 자동차
        Utils.createCar(scene, world, 'car1', -8000, -200, 4600, 4, 1, 2000,1100);
		Utils.createCar(scene, world, 'car1-1', -8000, -200, 4600,  3, 1, 4000,1100);
		
		Utils.createCar(scene, world, 'car2', -24700, -200, -4600, 4, 2, 2000, 1100);
		Utils.createCar(scene, world, 'car2-1', -24700, -200, -4600, 3, 2, 4000, 1100);
		
		Utils.createCar(scene, world, 'car3', -8000, 300, 1600, 4, 3, 4000, 1100);
		Utils.createCar(scene, world, 'car3-1', 8000, 300, -1600, 3, 3, 4000, 1100);
		
		Utils.createCar(scene, world, 'car4', -24700, -200, 6500, 4, 4, 1000, 2000);
		Utils.createCar(scene, world, 'car4-1', -24700, -200, -6500, 3, 4, 1000, 2000);
